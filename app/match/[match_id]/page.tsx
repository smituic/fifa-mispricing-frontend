...
export default async function MatchPage({
  ...
  return (
    <div className="mx-auto max-w-7xl space-y-14 px-6 py-8 md:px-8">
      {/* BACK BUTTON */}
      <div className="mb-2">
        <Link
          href="/fifa"
      ...
      {/* EV CHART - MOVED UP AND MADE COMPACT */}
      <div className="mx-auto w-full max-w-4xl rounded-2xl border border-zinc-800 bg-zinc-900/30 p-5">
